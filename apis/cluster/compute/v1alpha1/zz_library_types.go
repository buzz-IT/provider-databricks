...
type LibraryInitParameters_2 struct {
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/cluster/storage/v1alpha1.DbfsFile
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/cluster/storage/v1alpha1.File
