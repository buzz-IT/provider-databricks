...
func (in *GCPEndpointInitParameters) DeepCopyInto(out *GCPEndpointInitParameters) {
	*out = *in
	if in.AllVPCScServices != nil {
		in, out := &in.AllVPCScServices, &out.AllVPCScServices
		*out = new(bool)
		**out = **in
	}
	if in.GoogleAPIEndpoints != nil {
		in, out := &in.GoogleAPIEndpoints, &out.GoogleAPIEndpoints
		*out = make([]GoogleAPIEndpointsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GCPEndpointObservation) DeepCopyInto(out *GCPEndpointObservation) {
	*out = *in
	...
	if in.GoogleAPIEndpoints != nil {
		in, out := &in.GoogleAPIEndpoints, &out.GoogleAPIEndpoints
		*out = make([]GoogleAPIEndpointsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GCPEndpointParameters) DeepCopyInto(out *GCPEndpointParameters) {
	*out = *in
	...
	if in.GoogleAPIEndpoints != nil {
		in, out := &in.GoogleAPIEndpoints, &out.GoogleAPIEndpoints
		*out = make([]GoogleAPIEndpointsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GoogleAPIEndpointsInitParameters) DeepCopyInto(out *GoogleAPIEndpointsInitParameters) {
	*out = *in
	if in.Endpoints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GoogleAPIEndpointsInitParameters.
func (in *GoogleAPIEndpointsInitParameters) DeepCopy() *GoogleAPIEndpointsInitParameters {
	if in == nil {
		return nil
	}
	out := new(GoogleAPIEndpointsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GoogleAPIEndpointsObservation) DeepCopyInto(out *GoogleAPIEndpointsObservation) {
	*out = *in
	if in.Endpoints != nil {
		in, out := &in.Endpoints, &out.Endpoints
		*out = make([]*string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GoogleAPIEndpointsObservation.
func (in *GoogleAPIEndpointsObservation) DeepCopy() *GoogleAPIEndpointsObservation {
	if in == nil {
		return nil
	}
	out := new(GoogleAPIEndpointsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GoogleAPIEndpointsParameters) DeepCopyInto(out *GoogleAPIEndpointsParameters) {
	*out = *in
	if in.Endpoints != nil {
		in, out := &in.Endpoints, &out.Endpoints
		*out = make([]*string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GoogleAPIEndpointsParameters.
func (in *GoogleAPIEndpointsParameters) DeepCopy() *GoogleAPIEndpointsParameters {
	if in == nil {
		return nil
	}
	out := new(GoogleAPIEndpointsParameters)
	in.DeepCopyInto(out)
	return out
}
