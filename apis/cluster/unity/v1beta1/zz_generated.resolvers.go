...
// ResolveReferences of this DataQualityMonitor.
func (mg *DataQualityMonitor) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
	...
	var err error
	{
		...
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			...
			Extract:      resource.ExtractParamPath("schema_id", true),
			Namespace:    mg.GetNamespace(),
...
// ResolveReferences of this QualityMonitorV2.
func (mg *QualityMonitorV2) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
