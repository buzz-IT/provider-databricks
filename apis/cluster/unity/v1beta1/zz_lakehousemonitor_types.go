...
type LakehouseMonitorCustomMetricsInitParameters struct {
...
type LakehouseMonitorCustomMetricsObservation struct {
...
type LakehouseMonitorCustomMetricsParameters struct {
...
type LakehouseMonitorInferenceLogInitParameters struct {
...
type LakehouseMonitorInferenceLogObservation struct {
...
type LakehouseMonitorInferenceLogParameters struct {
...
type LakehouseMonitorInitParameters struct {
	...
	CustomMetrics []LakehouseMonitorCustomMetricsInitParameters `json:"customMetrics,omitempty" tf:"custom_metrics,omitempty"`
	...
	InferenceLog *LakehouseMonitorInferenceLogInitParameters `json:"inferenceLog,omitempty" tf:"inference_log,omitempty"`
	...
	Snapshot *LakehouseMonitorSnapshotInitParameters `json:"snapshot,omitempty" tf:"snapshot,omitempty"`
	...
	TimeSeries *LakehouseMonitorTimeSeriesInitParameters `json:"timeSeries,omitempty" tf:"time_series,omitempty"`
...
type LakehouseMonitorObservation struct {
	...
	// Custom metrics to compute on the monitored table. These can be aggregate metrics, derived metrics (from already computed aggregate metrics), or drift metrics (comparing metrics across time windows).
	CustomMetrics []LakehouseMonitorCustomMetricsObservation `json:"customMetrics,omitempty" tf:"custom_metrics,omitempty"`
	...
	// Configuration for the inference log monitor
	InferenceLog *LakehouseMonitorInferenceLogObservation `json:"inferenceLog,omitempty" tf:"inference_log,omitempty"`
	...
	// Configuration for monitoring snapshot tables.
	Snapshot *LakehouseMonitorSnapshotParameters `json:"snapshot,omitempty" tf:"snapshot,omitempty"`
	...
	// Configuration for monitoring timeseries tables.
	TimeSeries *LakehouseMonitorTimeSeriesObservation `json:"timeSeries,omitempty" tf:"time_series,omitempty"`
...
type LakehouseMonitorParameters struct {
	...
	// Custom metrics to compute on the monitored table. These can be aggregate metrics, derived metrics (from already computed aggregate metrics), or drift metrics (comparing metrics across time windows).
	// +kubebuilder:validation:Optional
	CustomMetrics []LakehouseMonitorCustomMetricsParameters `json:"customMetrics,omitempty" tf:"custom_metrics,omitempty"`
	...
	// Configuration for the inference log monitor
	// +kubebuilder:validation:Optional
	InferenceLog *LakehouseMonitorInferenceLogParameters `json:"inferenceLog,omitempty" tf:"inference_log,omitempty"`
	...
	// Configuration for monitoring timeseries tables.
	// +kubebuilder:validation:Optional
	TimeSeries *LakehouseMonitorTimeSeriesParameters `json:"timeSeries,omitempty" tf:"time_series,omitempty"`
...
type LakehouseMonitorSnapshotInitParameters struct {
}

type LakehouseMonitorSnapshotObservation struct {
}

type LakehouseMonitorSnapshotParameters struct {
}

type LakehouseMonitorTimeSeriesInitParameters struct {
...
type LakehouseMonitorTimeSeriesObservation struct {
...
type LakehouseMonitorTimeSeriesParameters struct {
