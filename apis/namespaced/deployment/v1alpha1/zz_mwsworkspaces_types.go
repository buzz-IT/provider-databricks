...
type MwsWorkspacesInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/deployment/v1alpha1.MwsCredentials
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/deployment/v1alpha1.MwsNetworks
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/deployment/v1alpha1.MwsStorageConfigurations
