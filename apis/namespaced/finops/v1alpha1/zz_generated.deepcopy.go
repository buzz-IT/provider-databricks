...
func (in *AlertConfigurationsInitParameters) DeepCopyInto(out *AlertConfigurationsInitParameters) {
	*out = *in
	...
	if in.PrincipalOverrides != nil {
		in, out := &in.PrincipalOverrides, &out.PrincipalOverrides
		*out = make([]PrincipalOverridesInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AlertConfigurationsObservation) DeepCopyInto(out *AlertConfigurationsObservation) {
	*out = *in
	...
	if in.PrincipalOverrides != nil {
		in, out := &in.PrincipalOverrides, &out.PrincipalOverrides
		*out = make([]PrincipalOverridesObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AlertConfigurationsParameters) DeepCopyInto(out *AlertConfigurationsParameters) {
	*out = *in
	...
	if in.PrincipalOverrides != nil {
		in, out := &in.PrincipalOverrides, &out.PrincipalOverrides
		*out = make([]PrincipalOverridesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrincipalOverridesInitParameters) DeepCopyInto(out *PrincipalOverridesInitParameters) {
	*out = *in
	if in.OverrideThreshold != nil {
		in, out := &in.OverrideThreshold, &out.OverrideThreshold
		*out = new(string)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrincipalOverridesInitParameters.
func (in *PrincipalOverridesInitParameters) DeepCopy() *PrincipalOverridesInitParameters {
	if in == nil {
		return nil
	}
	out := new(PrincipalOverridesInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrincipalOverridesObservation) DeepCopyInto(out *PrincipalOverridesObservation) {
	*out = *in
	if in.OverrideThreshold != nil {
		in, out := &in.OverrideThreshold, &out.OverrideThreshold
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrincipalOverridesObservation.
func (in *PrincipalOverridesObservation) DeepCopy() *PrincipalOverridesObservation {
	if in == nil {
		return nil
	}
	out := new(PrincipalOverridesObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrincipalOverridesParameters) DeepCopyInto(out *PrincipalOverridesParameters) {
	*out = *in
	if in.OverrideThreshold != nil {
		in, out := &in.OverrideThreshold, &out.OverrideThreshold
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrincipalOverridesParameters.
func (in *PrincipalOverridesParameters) DeepCopy() *PrincipalOverridesParameters {
	if in == nil {
		return nil
	}
	out := new(PrincipalOverridesParameters)
	in.DeepCopyInto(out)
	return out
}
