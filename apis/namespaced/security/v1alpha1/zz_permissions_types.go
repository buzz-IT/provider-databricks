...
type AccessControlInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/security/v1alpha1.Group
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/security/v1alpha1.ServicePrincipal
...
type PermissionsInitParameters struct {
	...
	// cluster policy id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/compute/v1alpha1.ClusterPolicy
	...
	// Canonical unique identifier for the permissions in form of /<object type>/<object id>.
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/sql/v1alpha1.Dashboard
	...
	// directory id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/workspace/v1alpha1.Directory
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/mlflow/v1alpha1.MlflowExperiment
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// instance pool id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/compute/v1alpha1.InstancePool
	...
	// job id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/compute/v1alpha1.Job
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/mlflow/v1alpha1.MlflowModel
	...
	// repo id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/workspace/v1alpha1.Repo
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/serving/v1alpha1.ModelServing
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/mosaic/v1alpha1.VectorSearchEndpoint
	...
	// Canonical unique identifier for the permissions in form of /<object type>/<object id>.
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/workspace/v1alpha1.WorkspaceFile
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("object_id",false)
