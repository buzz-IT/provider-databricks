...
type AccessControlInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/security/v1beta1.Group
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/security/v1beta1.ServicePrincipal
...
type PermissionsInitParameters struct {
	...
	// app name
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/apps/v1beta1.App
	...
	// cluster policy id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/compute/v1beta1.ClusterPolicy
	...
	// Canonical unique identifier for the permissions in form of /<object type>/<object id>.
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/sql/v1beta1.Dashboard
	...
	// directory id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/workspace/v1beta1.Directory
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/mlflow/v1beta1.MlflowExperiment
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// instance pool id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/compute/v1beta1.InstancePool
	...
	// job id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/compute/v1beta1.Job
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/ai/v1beta1.KnowledgeAssistant
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/mlflow/v1beta1.MlflowModel
	...
	// repo id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/workspace/v1beta1.Repo
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/serving/v1beta1.ModelServing
	...
	// Supervisor Agent id
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/ai/v1beta1.SupervisorAgent
	...
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/mosaic/v1beta1.VectorSearchEndpoint
	...
	// Canonical unique identifier for the permissions in form of /<object type>/<object id>.
	// +crossplane:generate:reference:type=github.com/buzz-IT/provider-databricks/apis/namespaced/workspace/v1beta1.WorkspaceFile
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("object_id",false)
