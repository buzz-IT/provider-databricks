...
import (
	...
	"github.com/buzz-IT/provider-databricks/internal/clients"
	"github.com/buzz-IT/provider-databricks/internal/features"

	clusterapis "github.com/buzz-IT/provider-databricks/apis/cluster"
	namespacedapis "github.com/buzz-IT/provider-databricks/apis/namespaced"

	apiextensionsv1 "k8s.io/apiextensions-apiserver/pkg/apis/apiextensions/v1"

	clustercontroller "github.com/buzz-IT/provider-databricks/internal/controller/cluster"
	namespacedcontroller "github.com/buzz-IT/provider-databricks/internal/controller/namespaced"

	resolverapis "github.com/buzz-IT/provider-databricks/internal/apis"

	"github.com/buzz-IT/provider-databricks/internal/version"
)
...
func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Upjet-based Crossplane provider for Databricks").DefaultEnvars()
	...
	kingpin.FatalIfError(clusterapis.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Databricks APIs to scheme")
	kingpin.FatalIfError(resolverapis.BuildScheme(clusterapis.AddToSchemes), "Cannot register the cluster-scoped Databricks APIs with the API resolver's runtime scheme")
	kingpin.FatalIfError(namespacedapis.AddToScheme(mgr.GetScheme()), "Cannot add namespace-scoped Databricks APIs to scheme")
	kingpin.FatalIfError(resolverapis.BuildScheme(namespacedapis.AddToSchemes), "Cannot register the namespace-scoped Databricks APIs with the API resolver's runtime scheme")
