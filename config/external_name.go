...
var TerraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	"databricks_mlflow_webhook": config.IdentifierFromProvider,
	"databricks_model_serving": config.IdentifierFromProvider,
	"databricks_model_serving_provisioned_throughput": config.IdentifierFromProvider,
	"databricks_mount": config.IdentifierFromProvider,
	"databricks_mws_credentials": config.IdentifierFromProvider,
	"databricks_mws_customer_managed_keys": config.IdentifierFromProvider,
	"databricks_mws_log_delivery": config.IdentifierFromProvider,
...
var TerraformPluginFrameworkExternalNameConfigs = map[string]config.ExternalName{
	"databricks_account_federation_policy": config.IdentifierFromProvider,
	"databricks_account_iam_direct_group_member_v2": config.IdentifierFromProvider,
	"databricks_account_iam_group_v2": config.IdentifierFromProvider,
	"databricks_account_iam_service_principal_v2": config.IdentifierFromProvider,
	"databricks_account_iam_user_v2": config.IdentifierFromProvider,
	"databricks_account_iam_workspace_assignment_v2": config.IdentifierFromProvider,
	"databricks_account_network_policy": config.IdentifierFromProvider,
	"databricks_account_setting_user_preference_v2": config.IdentifierFromProvider,
	"databricks_account_setting_v2": config.IdentifierFromProvider,
	"databricks_ai_gateway_mcp_service": config.IdentifierFromProvider,
	"databricks_ai_gateway_model_provider_service": config.IdentifierFromProvider,
	"databricks_ai_gateway_model_service": config.IdentifierFromProvider,
	...
	"databricks_app": config.IdentifierFromProvider,
	"databricks_app_space": config.IdentifierFromProvider,
	"databricks_apps_settings_custom_template": config.IdentifierFromProvider,
	...
	"databricks_data_quality_monitor": config.IdentifierFromProvider,
	"databricks_data_quality_refresh": config.IdentifierFromProvider,
	"databricks_database_database_catalog": config.IdentifierFromProvider,
	"databricks_database_instance": config.IdentifierFromProvider,
	"databricks_database_synced_database_table": config.IdentifierFromProvider,
	...
	"databricks_domain": config.IdentifierFromProvider,
	"databricks_endpoint": config.IdentifierFromProvider,
	...
	"databricks_feature_engineering_feature": config.IdentifierFromProvider,
	"databricks_feature_engineering_kafka_config": config.IdentifierFromProvider,
	"databricks_feature_engineering_materialized_feature": config.IdentifierFromProvider,
	...
	"databricks_materialized_features_feature_tag": config.IdentifierFromProvider,
	"databricks_online_store": config.IdentifierFromProvider,
	"databricks_policy_info": config.IdentifierFromProvider,
	...
	"databricks_postgres_data_api": config.IdentifierFromProvider,
	...
	"databricks_postgres_snapshot_schedule": config.IdentifierFromProvider,
	"databricks_postgres_synced_table": config.IdentifierFromProvider,
	"databricks_quality_monitor": config.IdentifierFromProvider,
	"databricks_quality_monitor_v2": config.IdentifierFromProvider,
	"databricks_rfa_access_request_destinations": config.IdentifierFromProvider,
	"databricks_sandbox": config.IdentifierFromProvider,
	...
	"databricks_warehouses_default_warehouse_override": config.IdentifierFromProvider,
	"databricks_workspace_entity_tag_assignment": config.IdentifierFromProvider,
	"databricks_workspace_iam_direct_group_member_v2": config.IdentifierFromProvider,
	"databricks_workspace_iam_group_v2": config.IdentifierFromProvider,
	"databricks_workspace_iam_service_principal_v2": config.IdentifierFromProvider,
	"databricks_workspace_iam_user_v2": config.IdentifierFromProvider,
	"databricks_workspace_iam_workspace_assignment_v2": config.IdentifierFromProvider,
	"databricks_workspace_iam_workspace_identity_detail_v2": config.IdentifierFromProvider,
