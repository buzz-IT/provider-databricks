...
import (
	...
	clustercomputev1beta1 "github.com/buzz-IT/provider-databricks/apis/cluster/compute/v1beta1"
	clustersecurityv1beta1 "github.com/buzz-IT/provider-databricks/apis/cluster/security/v1beta1"
	namespacedapis "github.com/buzz-IT/provider-databricks/apis/namespaced"
	namespacedcomputev1beta1 "github.com/buzz-IT/provider-databricks/apis/namespaced/compute/v1beta1"
	namespacedsecurityv1beta1 "github.com/buzz-IT/provider-databricks/apis/namespaced/security/v1beta1"
...
func TestRoundTrip(t *testing.T) {
	...
	rt, err := roundtrip.NewRoundTripTest(provider, providerNamespaced, testScheme,
		...
		roundtrip.WithExcludeGroupKinds(
			...
			schema.GroupKind{Group: clustercomputev1beta1.CRDGroup, Kind: clustercomputev1beta1.Library_Kind},
			schema.GroupKind{Group: namespacedcomputev1beta1.CRDGroup, Kind: namespacedcomputev1beta1.Library_Kind},
		),
	)
	if err != nil {
