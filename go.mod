...
require (
	...
	github.com/databricks/databricks-sdk-go v0.178.0 // indirect
...
replace github.com/databricks/terraform-provider-databricks => ./hack/terraform-provider-databricks
